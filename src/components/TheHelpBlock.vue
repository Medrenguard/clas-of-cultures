...
export default {
  ...
  watch: {
    stage: function (nV, oV) { // StageLoop
      ...
      } else if (nV === 'MOVING_shipsExploringManualThenMoveStrict') {
        this.text = 'Этот регион можно расположить 2 способами. Выберите ориентацию региона, после чего флот будет перемещён на морской тайл в новом регионе'
      }
    }
  }
}
